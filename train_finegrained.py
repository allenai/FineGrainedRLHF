...
from fgrl.ppo import PPOTrainer
from fgrl.policy import T5Policy
from fgrl.value import T5Value
from fgrl.utils import ensure_dir, set_seed, reduce_mean, reduce_sum, ceil_div, whiten, clamp
...
class TextGenDataset(Dataset):
    def __init__(self, split, tokenizer, accelerator=None, length_limit=None):
        ...
        self.split = split
        self.dataset_fns = {
            "train": "examples/qa_feedback/data/processed_train_oracle.json",
            "dev": "examples/qa_feedback/data/processed_dev_oracle.json",
            "test": "examples/qa_feedback/data/processed_test_oracle.json"
        }
