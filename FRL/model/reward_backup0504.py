...
class BaselineReward(BasicReward):
    ...
    def __init__(self,
        ...
        self.baseline_reward = PreferenceReward(tokenizer, baseline_model_ckpt, rm_mean, rm_std)
    ...
    def get_reward(self, 
        ...
        for text_idx, generated_text in enumerate(generated_texts):
            ...
            this_reward[-1] = this_reward[-1] * self.scale + self.bias
...
class SubSentFineGrainedReward(BasicReward):
    ...
    def __init__(self,
                 ...
                 completeness_positive_reward = 1.0,
                 completeness_negative_reward = -1.0,
                 completeness_split_by_sentence = False,
                 sep = "</s>",
                 reward_mode = 0,
                ):
        ...
        self.completeness_reward = CompletenessReward(tokenizer,
            ...
            completeness_positive_reward,
            completeness_negative_reward,
            split_by_sentence=completeness_split_by_sentence,
            sep = sep)
